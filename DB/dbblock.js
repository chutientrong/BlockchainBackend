...
//         return db.query("select * from blocks where indexs=?", [index], callback);
//     },
//     addBlock: function(blocks, callback) {
//         return db.query("Insert into blocks (indexs,previous_hash,data,timestamps,hash) values(?,?,?,?,?)", [blocks.index, blocks.previousHash, blocks.data, blocks.timestamp, blocks.hash], callback);
//     },
